        ...
        <>
            <div>
                ...
                <div className='text-white grid justify-center items-center py-20 h-screen w-screen overflow-x-auto '>
                    <div className="relative overflow-x-auto shadow-md sm:rounded-lg 2xl:translate-x-[120px] xl:translate-x-[200px] lg:translate-x-[300px]  translate-y-48 m-5">
                                                    ...
                                                    </button>
                                                    {
                                                        ...
                                                        isOpen === index && (
                                                            ...
                                                            <div id="dropdownAction" className="z-10 absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                                                ...
                                                                <div className="py-1">
                                                                {!product.locked ?
                                                                    <button onClick={()=>handleEnable()} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Lock</button>
                                                                    :
                                                                    <button onClick={()=>handleDisable()} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Open</button>
