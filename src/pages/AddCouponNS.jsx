                        ...
                        <form className='grid justify-center  gap-6 grid-cols-1' onSubmit={handleSubmit}>
                            ...
                            {isLoading3 ? <p>Loading</p> :
                                <div className="grid justify-center items-center gap-3 max-[1815px]:grid">
                                    ...
                                    {
                                        isOpen && (
                                            <div className=' z-50 absolute right-[465px] top-[140px] h-[50px] max-[1736px]:right-[400px] max-[1536px]:right-[300px] max-[1200px]:right-[180px] max-[724px]:right-[70px] max-[519px]:right-[15px]'>
