...
export const AddBlogapi = baseUrl+'/api/v4/content/post';
...
export const ActivateButtonapi = baseUrl+'/api/v4/custom/product/';
...
export const UpdateProductDataapi = baseUrl+'/api/v4/custom/product/';
export const DeleteProductImgapi = baseUrl+'/api/v4/custom/product/';
...
export const GetAllBlogsapi = baseUrl+'/api/v4/public/post/all';
export const GetAllBlogsDataapi = baseUrl+'/api/v2/content/post/';
export const DeleteBlogsBtnapi = baseUrl+'/api/v4/content/post/';
export const DeleteBlogsImgBtnapi = baseUrl+'/api/v1/content/post/picture/delete/';
export const PutBlogsImgBtnapi = baseUrl+'/api/v4/content/post/';
export const UpdateBlogsapi = baseUrl+'/api/v4/content/post/';
/* ******************APIs****************** */